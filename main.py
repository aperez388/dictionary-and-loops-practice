...
#     print(student['HR'])
#     print(student['GL'])
#     # print middle name and last name
    # print(student['MName'])
    # print(student["LName"])
    # print("_"*25)
...
#         student['FName'] = 'Mohammed'
#         student['LName'] = 'Hassan'
#         student['GL'] = 11
#         student['HR'] = 'H788'
...
del students[4]  # Removes the first student in the list
del students[-1]
...
for student in students:
    if student['CPSID'] == 10000022: # Check if student iD
...
for student in students:
    student['ContactNumber'] = 'N/A'  # Assign a default or specific value
print(students)
